...
x_train, y_train, x_cv, y_cv, x_test, y_test = utils.prepare_dataset('assets/c2w3_lab2_data1.csv')
...
x_train, y_train, x_cv, y_cv, x_test, y_test = utils.prepare_dataset('assets/c2w3_lab2_data2.csv')
...
# Prepare the dataset
x_train, y_train, x_cv, y_cv, x_test, y_test = utils.prepare_dataset('assets/c2w3_lab2_data4.csv')
